...
public class Room4 extends JFrame {
	...
	public Room4() {
		...
		Image imgs=new ImageIcon(this.getClass().getResource("/4 star.png")).getImage();
		
		JComboBox comboBox = new JComboBox();
		comboBox.setModel(new DefaultComboBoxModel(new String[] {"Normal View", "215", "216", "217", "218", "219", "220", "310", "311", "312", "313", "314", "410", "411", "412", "413", "Better View", "315", "316", "317", "318", "319", "320", "417", "418", "419", "420"}));
		comboBox.setBounds(147, 91, 86, 20);
		contentPane.add(comboBox);
		
	
		
		JLabel label = new JLabel("");
		label.setBounds(-10, 0, 444, 261);
