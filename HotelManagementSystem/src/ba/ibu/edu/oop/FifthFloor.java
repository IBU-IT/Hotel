...
public class FifthFloor {
	...
	public static void Fifth() {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					FifthFloor window = new FifthFloor();
	...
	private void initialize() {
		...
		label_11.setIcon(new ImageIcon("C:\\Users\\Toshiba\\Desktop\\5f.jpg"));
		...
		label_13.setIcon(new ImageIcon("C:\\Users\\Toshiba\\Desktop\\5d.jpg"));
