...
public class SixthFloor {
	...
	private void initialize() {
		...
		label_8.setIcon(new ImageIcon("6a.jpg"));
		...
		label_9.setIcon(new ImageIcon("6b.jpg"));
		...
		label_10.setIcon(new ImageIcon("6c.jpg"));
		label_10.setBounds(1229, 109, 107, 73);
		frame.getContentPane().add(label_10);
		
		JLabel label_11 = new JLabel("");
		label_11.setIcon(new ImageIcon("6f.jpg"));
		...
		label_12.setIcon(new ImageIcon("6e.jpg"));
		...
		label_13.setIcon(new ImageIcon("6d.jpg"));
		...
		label_14.setIcon(new ImageIcon("6ee.jpg"));
		...
		label_15.setIcon(new ImageIcon("6ee1.jpg"));
		...
		label_16.setIcon(new ImageIcon("6ee2.jpg"));
