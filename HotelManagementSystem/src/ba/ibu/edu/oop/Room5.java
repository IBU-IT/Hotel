...
public class Room5 extends JFrame {
	...
	public Room5() {
		...
		lblDateIn.setForeground(new Color(0, 0, 0));
		...
		lblNoOfDays.setForeground(new Color(0, 0, 0));
		...
		lblNoofAdults.setForeground(new Color(0, 0, 0));
		...
		Image imag=new ImageIcon(this.getClass().getResource("/room.png")).getImage();
		
		JComboBox comboBox = new JComboBox();
		comboBox.setModel(new DefaultComboBoxModel(new String[] {"Normal View", "510", "511", "512", "513", "514", "Better View", "515", "516", "517", "518", "519", "520"}));
