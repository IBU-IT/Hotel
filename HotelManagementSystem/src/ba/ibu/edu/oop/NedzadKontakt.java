...
public class NedzadKontakt extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					NedzadKontakt frame = new NedzadKontakt();
	...
	public NedzadKontakt() {
		...
		JLabel lblNedzadGrbo = new JLabel("Nedzad Grbo");
		lblNedzadGrbo.setFont(new Font("Times New Roman", Font.PLAIN, 15));
		lblNedzadGrbo.setBounds(175, 11, 144, 26);
		contentPane.add(lblNedzadGrbo);
		...
		JLabel lblFracncuskeRevolucijeBb = new JLabel("Emila Zole 3, Sarajevo, Bosna");
		...
		JLabel label_3 = new JLabel("+387(61) 156324");
		...
		JLabel label_4 = new JLabel("+387(33) 154236");
		...
		JLabel lblNedzadGrbohotmailcom = new JLabel("nedzad_grbo@hotmail.com");
		lblNedzadGrbohotmailcom.setFont(new Font("Times New Roman", Font.PLAIN, 12));
		lblNedzadGrbohotmailcom.setBounds(108, 225, 153, 14);
		contentPane.add(lblNedzadGrbohotmailcom);
		
		JLabel lblRoomsCheif = new JLabel("Pool & Sauna Cheif");
