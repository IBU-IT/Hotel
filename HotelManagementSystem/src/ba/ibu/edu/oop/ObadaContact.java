...
public class ObadaContact extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ObadaContact frame = new ObadaContact();
	...
	public ObadaContact() {
		...
		JLabel lblObadaAlmonajed = new JLabel("Obada Almonajed");
		lblObadaAlmonajed.setFont(new Font("Times New Roman", Font.PLAIN, 15));
		lblObadaAlmonajed.setBounds(175, 11, 144, 26);
		contentPane.add(lblObadaAlmonajed);
		...
		JLabel lblObadaAlmonajedhotmailcom = new JLabel("obada_almonajed@hotmail.com");
		lblObadaAlmonajedhotmailcom.setFont(new Font("Times New Roman", Font.PLAIN, 12));
		lblObadaAlmonajedhotmailcom.setBounds(108, 225, 153, 14);
		contentPane.add(lblObadaAlmonajedhotmailcom);
