...
public class AbuContact extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					AbuContact frame = new AbuContact();
	...
	public AbuContact() {
		...
		JLabel lblAbdurahmanAlmonajed = new JLabel("Abdurahman Almonajed");
		...
		Image img=new ImageIcon(this.getClass().getResource("/abu.png")).getImage();
		...
		JLabel lblFracncuskeRevolucijeBb = new JLabel("Fracncuske Revolucije bb, Sarajve, Bosna");
		...
		JLabel label_3 = new JLabel("+387(61) 61091675");
		...
		JLabel lblAbudalmonajedhotmailcom = new JLabel("abud_almonajed@hotmail.com");
		...
		JLabel lblRoomsCheif = new JLabel("Rooms Cheif");
		lblRoomsCheif.setFont(new Font("Times New Roman", Font.PLAIN, 15));
		lblRoomsCheif.setBounds(175, 63, 115, 14);
